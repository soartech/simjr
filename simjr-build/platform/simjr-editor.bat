...
rem Usage:
rem
rem simjr-editor.bat scenario-file
rem
...
java %SIMJR_OPTS% -Dsimjr.home=%SIMJR_HOME% -Dsimjr.app=editor "-Dsimjr.args=%*" -jar org.eclipse.osgi_3.4.2.R34x_v20080826-1230.jar -console
