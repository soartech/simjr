...
rem Usage:
rem
rem simjr-headless.bat scenario-file
rem
...
java %JAVA_OPTS% %SIMJR_OPTS% -Dsimjr.home=%SIMJR_HOME% -Dsimjr.app=headless "-Dsimjr.args=%*" -jar org.eclipse.osgi_3.4.2.R34x_v20080826-1230.jar -console
