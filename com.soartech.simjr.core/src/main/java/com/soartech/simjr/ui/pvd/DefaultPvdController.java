 ...
 *
 */
public class DefaultPvdController implements PvdController
{
    ...
    private class MouseHandler extends MouseAdapter
    {
        ...
        {
            DefaultPvdController.this.mousePressed(e);
        }
        
        public void mouseReleased(MouseEvent e)
        {
            DefaultPvdController.this.mouseReleased(e);
        }
    }
    ...
    private class MouseMotionHandler extends MouseMotionAdapter
    {
        ...
        public void mouseDragged(MouseEvent e)
        {
            if(SwingUtilities.isLeftMouseButton(e))
            {
                if (view.isDraggingEntity())
                {
                    DefaultPvdController.this.dragEntity(e);
                }
                else
                {
                    DefaultPvdController.this.dragPan(e);
                }
            }
        }
        ...
        {
            DefaultPvdController.this.mouseMoved(e);
        }
    }
